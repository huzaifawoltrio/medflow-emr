      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <Card className="shadow-lg">
          <CardHeader className="text-center space-y-2">
            ...
            <p className="text-gray-600 text-sm">Join our secure healthcare platform</p>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" className="w-full bg-blue-600 hover:bg-blue-700" disabled={!agreeToTerms}>
                Create Account →
              </Button>
            </form>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
              <div className="flex items-start space-x-2">
                ...
                <div className="text-xs text-blue-800">
                  ...
                  <p>Your medical data is protected with enterprise-grade encryption and security protocols.</p>
                </div>
              </div>
            </div>
          </CardContent>
