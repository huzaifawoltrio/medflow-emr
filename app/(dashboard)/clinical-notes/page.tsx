...
const sampleNotes = [
  {
    ...
    type: "Follow-up",
    status: "completed",
    content: "Patient reports improved mood and sleep patterns. Continue current medication regimen.",
  ...
  },
  {
    ...
    status: "draft",
    content: "New patient presenting with anxiety symptoms. Comprehensive evaluation completed.",
...
export default function ClinicalNotes() {
  ...
  const filteredNotes = notes.filter((note) => {
    ...
    const matchesType = typeFilter === "all" || note.type.toLowerCase().includes(typeFilter.toLowerCase())
  ...
  const handleCreateNote = () => {
    if (newNote.patientName && newNote.content) {
      const note = {
        ...
        billingCodes: newNote.billingCodes.split(",").map((code) => code.trim()),
      }
      setNotes([note, ...notes])
...
FOLLOW-UP INSTRUCTIONS:`,
    ...
    if (templateId !== "custom" && templates[templateId as keyof typeof templates]) {
      setNewNote({
        ...newNote,
        type: templates[templateId as keyof typeof templates].type,
        content: templates[templateId as keyof typeof templates].content,
      })
    }
          ...
          <Dialog open={isNewNoteOpen} onOpenChange={setIsNewNoteOpen}>
            ...
            <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
              <DialogHeader>
                ...
                <DialogDescription>Document patient encounter and clinical findings.</DialogDescription>
              </DialogHeader>
              <div className="grid gap-4 py-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setNewNote({ ...newNote, billingCodes: e.target.value })}
                  />
                </div>
                <div className="space-y-2">
        ...
        <div className="flex flex-wrap items-center gap-4 mb-6">
          <div className="flex-1 min-w-64">
            <div className="relative">
              ...
              <Input
                placeholder="Search notes by patient name, content, or date..."
                value={searchTerm}
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-3">
                      ...
                      <div>
                        <p className="font-medium text-gray-900">
                          {note.patientName} <span className="text-sm text-gray-500">({note.patientId})</span>
                        </p>
                        <div className="flex items-center space-x-4 text-sm text-gray-600">
                          ...
                          <span className="text-blue-600 font-medium">{note.type}</span>
                          <Badge
                            className={
                    ...
                    <div className="flex items-center space-x-2">
                      <span className="text-sm font-medium text-gray-700">Billing Codes:</span>
