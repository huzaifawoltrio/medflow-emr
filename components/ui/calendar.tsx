...
import { Button, buttonVariants } from "@/components/ui/button"; // Assuming you have these components
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      // ERROR FIX: The `day` prop is an object containing a `date` property.
      // Changed `day.toLocaleDateString()` to `day.date.toLocaleDateString()` to correctly access the Date object.
